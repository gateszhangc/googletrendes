(async () => {
  ...
  const stateKey = "__GT_RISING_ROWS_V17__";
  const rowsStorageKey = "GT_RISING_ROWS_V17";
  const checkpointStorageKey = "GT_RISING_CHECKPOINT_V17";
  const popupId = "gt_rising_popup_v17";
